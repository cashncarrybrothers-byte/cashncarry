...
async function getCredentials() {
    ...
    console.log('Find these at: crm.cashncarry.se/wp-admin → WooCommerce → Settings → Advanced → REST API\n');
...
async function wcApi(endpoint, method = 'GET', data = null, credentials) {
    const url = new URL(`https://crm.cashncarry.se/wp-json/wc/v3/${endpoint}`);
