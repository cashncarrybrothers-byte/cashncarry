...
export function FoodConcierge() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            role: 'assistant',
            content: 'Hello! I\'m your **Brothers Shopping Assistant**. I can help you find products, suggest items, and answer questions about our groceries. What are you looking for today?',
            timestamp: new Date(),
        },
    ]);
    ...
    const generateResponse = (input: string): string => {
        ...
        if (lowerInput.includes('hello') || lowerInput.includes('hi') || lowerInput.includes('hey')) {
            return "Hello! Welcome to Brothers Cash & Carry. How can I assist you today? Feel free to ask about our products, delivery, or store information!";
        }
                    ...
                    >
                        ...
                        <div className="relative flex items-center gap-3 bg-gradient-to-r from-primary-900 via-primary-800 to-primary-900 p-5 text-white">
                            ...
                            <div className="flex-1">
                                <h3 className="font-heading text-lg font-bold" style={{ color: '#1a3d35' }}>Brothers Assistant</h3>
