...
export const metadata: Metadata = {
  title: 'Weekend Biryani Pre-Orders | Brothers Cash & Carry',
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://crm.cashncarry.se/wp-content/uploads/2026/01/dum-biryani-scaled.jpg',
        width: 1200,
        height: 630,
    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white dark:from-gray-900 dark:to-gray-950">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-orange-600 to-red-600 text-white">
        ...
        <div
          ...
          style={{ backgroundImage: 'url(https://crm.cashncarry.se/wp-content/uploads/2026/01/Ideal-Biryani-Stockholm.jpg)' }}
        ></div>
        {/* Overlay */}
