  ...
  try {
    ...
    try {
      if (process.env.SMTP_HOST && process.env.SMTP_USER && process.env.SMTP_PASS) {
        ...
        const adminEmail = process.env.ADMIN_EMAIL || 'support@cashncarry.se';
        ...
        await transporter.sendMail({
          from: `"Brothers Cash & Carry Exit Survey" <${fromEmail}>`,
          to: recipients,
                        ...
                        <tr>
                          <td style="padding-top: 20px; border-top: 1px solid #e0e0e0;">
                            <p style="margin: 0; color: #999999; font-size: 12px; text-align: center;">
                              This feedback was collected via exit-intent survey at <a href="https://cashncarry.se" style="color: #DC2626; text-decoration: none;">cashncarry.se</a>
                            </p>
                          </td>
                        </tr>
                      </table>
