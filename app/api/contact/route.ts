    ...
    try {
      if (process.env.SMTP_HOST && process.env.SMTP_USER && process.env.SMTP_PASS) {
        ...
        await transporter.sendMail({
          from: `"Brothers Cash & Carry Contact" <${fromEmail}>`,
          to: recipients,
          replyTo: email,
                        ...
                        <tr>
                          <td style="padding-top: 20px; border-top: 1px solid #e0e0e0;">
                            <p style="margin: 0; color: #999999; font-size: 12px; text-align: center;">
                              This email was sent from the contact form at <a href="https://cashncarry.se" style="color: #8B1538; text-decoration: none;">cashncarry.se</a>
                            </p>
