...
export const metadata: Metadata = {
    title: 'Refund & Return Policy | Brothers Cash & Carry',
                            ...
                            <section className="space-y-6">
                                ...
                                <div className="space-y-6">
                                    <div className="p-6 rounded-xl border bg-card/50">
                                        ...
                                        <p style={{ fontSize: '15.13px' }} className="text-muted-foreground">You are welcome to return eligible items directly to our physical store at {brandProfile.address.street}, {brandProfile.address.postalCode} {brandProfile.address.city}. Please bring your proof of purchase (order confirmation or receipt) with you.</p>
                                    </div>
                                    <div className="p-6 rounded-xl border bg-card/50">
