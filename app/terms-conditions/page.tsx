...
import { FileText, ShoppingCart, CreditCard, Truck, Scale, Shield, Mail, Phone, MapPin } from 'lucide-react';
import Link from 'next/link';

export const metadata: Metadata = {
  title: 'Terms & Conditions | Brothers Cash & Carry',
  description: 'Terms and conditions for using cashncarry.se. Learn about our policies on orders, payments, delivery, and more.',
  alternates: {
