...
function getAuthorInfo(post: any): { name: string; avatar?: string } {
  ...
  return { name: 'Brothers Cash & Carry' };
}
...
export default async function BlogPostPage({ params }: Props) {
  ...
  const decodedTitle = decodeHtmlEntities(post.title.rendered);
  const currentUrl = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://cashncarry.se'}/blog/${slug}`;
              ...
              <div className="sticky top-24 space-y-8">
                ...
                <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
                  ...
                  <div className="rounded-lg overflow-hidden mb-4">
                    <iframe
                      src="https://maps.google.com/maps?q=Regndroppsgatan+3,+194+49+Upplands+Väsby,+Sweden&t=&z=15&ie=UTF8&iwloc=&output=embed"
                      width="100%"
                      height="250"
                      style={{ border: 0 }}
                      allowFullScreen
                  ...
                  <div className="text-sm text-muted-foreground">
                    <p className="font-semibold text-foreground">Brothers Cash & Carry</p>
