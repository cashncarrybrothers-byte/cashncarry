                ...
                <div className="container mx-auto px-4 py-16 md:py-20">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-muted-foreground" style={{
                            ...
                            From our store in Upplands Väsby to your door. We offer free delivery across all of Stockholm and fast shipping throughout Sweden and Europe.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            ...
                            <section className="space-y-6">
                                ...
                                <div className="space-y-6">
                                    <div className="p-6 rounded-xl border bg-card/50">
                                        <h3 style={{ fontSize: '20px', fontWeight: 600 }} className="mb-3">1. Brothers Cash & Carry Local Delivery (Our Own Service)</h3>
                            ...
                            <section className="space-y-6">
                                ...
                                <div className="p-6 rounded-xl border bg-card/50">
                                    <div className="space-y-4 text-muted-foreground" style={{ fontSize: '15.13px' }}>
                                        <p>You are always welcome to place your order online and collect it from our store in Upplands Väsby at no extra cost.</p>
                                        <ul className="list-disc pl-5 space-y-2">
                                            <li><strong>Cost:</strong> Free</li>
                                            <li><strong>Location:</strong> {brandProfile.address.street}, {brandProfile.address.postalCode} {brandProfile.address.city}</li>
