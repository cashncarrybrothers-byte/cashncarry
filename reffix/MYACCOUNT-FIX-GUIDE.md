...
- ✅ Use WordPress ID as WooCommerce ID (they're usually identical in our Brothers Cash & Carry setup)
...
```bash
curl -X GET "https://cashncarry.se/wp-json/wc/v3/customers/{ID}" \
...
5. **Test Email Search:**
```bash
curl -X GET "https://cashncarry.se/wp-json/wc/v3/orders?search=user@email.com" \
  -u "consumer_key:consumer_secret"
```
...
This guide should help you quickly fix the My Account integration on Brothers Cash & Carry or any new website using this template!
