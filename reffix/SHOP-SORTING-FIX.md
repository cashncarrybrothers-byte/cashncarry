...
3. WooCommerce API requires **both** `orderby` and `order` parameters for price sorting in Brothers Cash & Carry storefront
...
This fix is ready to deploy for Brothers Cash & Carry. The changes are minimal and focused:
- ✅ No breaking changes
- ✅ Backward compatible
...
This fix ensures that price sorting works correctly across all shop and archive pages on Brother Cash & Carry!
