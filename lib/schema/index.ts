 ...
 *
 * const productJsonLd = wooCommerceProductSchema(product, { baseUrl: 'https://cashncarry.se' });
 * const breadcrumbJsonLd = breadcrumbSchema(productBreadcrumbs(product, 'https://cashncarry.se'));
 *
 ...
 *
 * const categoryJsonLd = productCategorySchema(category, products, 'https://cashncarry.se');
 * const breadcrumbJsonLd = breadcrumbSchema(categoryBreadcrumbs(category, 'https://cashncarry.se'));
 * ```
 *
 ...
 *   websiteSchema({ name: 'Brothers Cash & Carry', url: 'https://cashncarry.se' })
 * );
 *
 ...
 *
 * const articleJsonLd = wordPressArticleSchema(post, 'https://cashncarry.se');
 ...
 *
 * const faqJsonLd = idealIndiskaFAQSchema('https://cashncarry.se');
